...
function Dashboard() {
  ...
  const DEMO_PAYLOAD_HEATMAP = {
    correlation_id: "",
    raw_text_query: "gap_analysis",
    user_info: {
      identity: { user_id: "", email: "", name: "", tenant_id: "" },
      auth: { api_key: "", use_idp: false, idp_type: "", idp_server: {}, id_token: "", access_token: "", internal_token: "" },
      license: { tenant_id: "", plan: "", subscription_level: "", rate_limit: 0 },
      rbac: { roles: [], permissions: [] },
      abac: { department: "", country: "", groups: [], security_level: "" },
    },
    action: { actionPerformed: "", payload: {} },
    files: [],
    execution_params: { sku_ids: [], sku_id: "SKU-001", sku: "SKU-001", query: "Is this keyboard silent?", run_id: "string", additionalProp1: {} },
    channel_type: "WEB",
  ...
  const DEMO_PAYLOAD_DISTRIBUTION = {
    correlation_id: "",
    raw_text_query: "description_suggestion",
    user_info: {
      identity: { user_id: "", email: "", name: "", tenant_id: "" },
      auth: { api_key: "", use_idp: false, idp_type: "", idp_server: {}, id_token: "", access_token: "", internal_token: "" },
      license: { tenant_id: "", plan: "", subscription_level: "", rate_limit: 0 },
